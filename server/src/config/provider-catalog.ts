...
export const PROVIDER_CATALOG: ProviderCatalogEntry[] = [
  ...
  },
  {
    ...
    keyFormat: 'id.secret', recommendedModels: ['glm-4.7-flash', 'glm-4.5', 'glm-4-flash'],
    capabilities: ['chat', 'reasoning', 'vision', 'tool-use'], supportsModelFetch: true,
  ...
  {
    id: 'agnes25', name: 'Agnes AI 2.5', category: 'domestic', protocols: [openAICompatible],
    endpoints: [{ id: 'cn', name: 'Agnes AI 2.5 API', region: '中国大陆', baseUrl: 'https://api.agnes-ai.cn/v1', modelListPath: '/models', authMode: 'bearer' }],
    keyFormat: 'sk-…', recommendedModels: ['agnes-2.5-flash'],
    capabilities: ['chat', 'reasoning'], supportsModelFetch: false,
    officialWebsite: 'https://api.agnes-ai.cn/', registrationUrl: 'https://api.agnes-ai.cn/v1',
    apiKeyGuideUrl: 'https://api.agnes-ai.cn/v1', officialDocsUrl: 'https://api.agnes-ai.cn/v1',
    apiKeySteps: ['在 Agnes AI 控制台创建 API Key', '将 Key 安全保存到服务端密钥管理', '在模型配置中使用 agnes-2.5-flash'],
    commonErrors: ['401：API Key 无效或已过期', '404：模型名或接口路径不正确', '429：请求频率或配额受限'], reviewedAt: '2026-07-31',
  },
  {
