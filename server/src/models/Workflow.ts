...
export const NODE_TYPES: { type: string; label: string; category: string; icon: string; color: string; defaultConfig: Record<string, any> }[] = [
  ...
  // AI 能力
  { type: 'ai_chat', label: 'AI 对话', category: 'AI', icon: 'RobotOutlined', color: '#1890ff', defaultConfig: { provider: 'agnes25', model: 'agnes25/agnes-2.5-flash', temperature: 0.7, systemPrompt: '你是一个有用的助手。', maxTokens: 2000 } },
