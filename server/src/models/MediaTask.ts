...
const MediaTaskSchema = new Schema<IMediaTask>(
  {
    ...
    status: { type: String, required: true, enum: ['completed', 'processing', 'failed'], default: 'processing' },
    ...
    segmentTaskIds: { type: [String], default: undefined },
