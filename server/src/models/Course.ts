...
const CourseSchema = new Schema<ICourse>(
  {
    sourceCourseId: {
      type: String,
      trim: true,
      maxlength: [100, 'sourceCourseId cannot exceed 100 characters']
    },
    title: {
      type: String,
    ...
    freePreviewChapters: {
      ...
      validate: {
        ...
        message: 'freePreviewChapters must be an integer'
      }
    },
    requiredPlan: {
      type: String,
...
// 索引
CourseSchema.index({ sourceCourseId: 1 }, { unique: true, sparse: true });
