...
exports.CATALOG = [
    ...
    // ───────── 声明式技能包（prompt 类，安装即入库） ─────────
    {
        ...
        skillPackage: {
            ...
            prompt: {
                ...
                userTemplate: '请基于以下本周工作要点生成周报，三段式：1) 本周进展 2) 风险与阻塞 3) 下周计划。\n要点：{{input}}',
                maxTokens: 800,
                temperature: 0.4,
            },
        },
    },
    {
        ...
        skillPackage: {
            ...
            kind: 'prompt',
            prompt: {
                system: '你是资深代码审查专家。请严格输出 JSON：{ "issues": [{"severity":"阻断|重要|建议","file":"","desc":"","fix":""}] }。',
    ...
    },
    {
        ...
        skillPackage: {
            ...
            prompt: {
                ...
                userTemplate: '请把以下会议记录整理为纪要，三部分：1) 关键结论 2) 待办事项（负责人+截止日期）3) 风险与遗留问题。\n记录：{{input}}',
                maxTokens: 1000,
                temperature: 0.3,
            },
        },
...
//# sourceMappingURL=external-market-catalog.js.map