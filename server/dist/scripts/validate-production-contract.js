...
exports.createStaticProductionContractEnv = createStaticProductionContractEnv;
exports.validateStaticProductionContract = validateStaticProductionContract;
/**
...
const validate_production_config_1 = require("./validate-production-config");
function rsaFixtureCertificate() {
    const certificate = tls_1.default.rootCertificates.find((pem) => {
        try {
            return new crypto_1.default.X509Certificate(pem).publicKey.asymmetricKeyType === 'rsa';
        }
        catch {
            return false;
        }
...
function createStaticProductionContractEnv() {
...
function validateStaticProductionContract() {
    (0, validate_production_config_1.validateProductionCredentials)(createStaticProductionContractEnv());
}
...
//# sourceMappingURL=validate-production-contract.js.map