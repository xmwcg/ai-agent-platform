...
exports.publicProviderCatalog = publicProviderCatalog;
...
function getProvider(providerId) {
    return exports.PROVIDER_CATALOG.find((provider) => provider.id === providerId);
}
function getProviderEndpoint(providerId, endpointId) {
...
function publicProviderCatalog() {
    return exports.PROVIDER_CATALOG.map((provider) => ({
        ...provider,
