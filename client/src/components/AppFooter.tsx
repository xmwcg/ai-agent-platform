...
import {
  ...
  PlayCircleOutlined, ShoppingCartOutlined, CustomerServiceOutlined,
} from "@ant-design/icons";

const { Text, Paragraph } = Typography;

const BRAND = "NexMind by AIbak";
const BRAND_SLOGAN = "打造您的全站 AI 应用平台";
const SITE_URL = "https://aibak.site";
const CONTACT_EMAIL = "xmwcg5059@outlook.com";
const COMPANY_NAME = "厦门金奕鸣科技有限公司";
const ICP_NUMBER = "闽ICP备2026027156号-1";
const PSB_NUMBER = ""; // 公安联网备案通过后填入完整编号，如：闽公网安备 3502060200XXXX号
const BROWSER_TIP = "建议您使用 Edge、Chrome 80+、Firefox 86+、360 极速模式等主流浏览器浏览本网站";
    ...
    >
      ...
      <div style={{
        ...
        <Button
          ...
          onClick={() => go("/jinwangtong-demo")}
          style={{ borderRadius: 10, height: 40, fontWeight: 600, fontSize: 14 }}
        >
          在线体验
        </Button>
        <Button
          ...
          onClick={() => go("/jinwangtong")}
          style={{
            borderRadius: 10, height: 40, fontWeight: 600, fontSize: 14,
        ...
        <Button
          ...
          onClick={() => setKfOpen(true)}
          style={{ borderRadius: 10, height: 40, fontWeight: 600, fontSize: 14, color: "#07c160", borderColor: "#07c160" }}
        >
          联系客服
        </Button>
        <Button
      ...
      >
        <div style={{ textAlign: "center" }}>
          ...
          <img
            src="/wechat-qr.png"
            alt="个人微信二维码"
            style={{ width: 180, height: 180, borderRadius: 8, border: "1px solid #eee" }}
      ...
      <div style={{
        ...
        <div style={{ textAlign: "center", minWidth: 130 }}>
          ...
          <div style={{ fontSize: 12, color: "var(--text-secondary)", marginTop: 6, display: "flex", alignItems: "center", justifyContent: "center", gap: 5, cursor: "pointer" }} onClick={() => window.open(WEWORK_KF_URL, "_blank")}>
      ...
      <div style={{
        ...
        <div style={{ display: "flex", flexWrap: "wrap", justifyContent: "center", gap: "8px 16px" }}>
          ...
          <a href="https://beian.miit.gov.cn/" target="_blank" rel="noopener noreferrer" style={{ fontSize: 12, color: "var(--text-tertiary)" }}>
            {ICP_NUMBER}
          </a>
        </div>
        {PSB_NUMBER && (
          <div style={{ display: "flex", flexWrap: "wrap", justifyContent: "center", gap: "8px 16px" }}>
            <a href="https://beian.mps.gov.cn/" target="_blank" rel="noopener noreferrer" style={{ fontSize: 12, color: "var(--text-tertiary)", display: "flex", alignItems: "center", gap: 4 }}>
              <img src="/gongan-icon.png" alt="公安备案图标" style={{ width: 16, height: 17 }} />
              {PSB_NUMBER}
            </a>
          </div>
        )}
        ...
        <div style={{ display: "flex", flexWrap: "wrap", justifyContent: "center", gap: 16, marginTop: 4 }}>
          {[
            { label: "服务条款", path: "/terms" },
            { label: "隐私政策", path: "/privacy" },
            { label: "退款政策", path: "/refund-policy" },
