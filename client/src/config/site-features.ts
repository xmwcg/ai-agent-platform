...
export const SITE_FEATURES: SiteFeature[] = [
  { id: 'platform-status', title: '平台状态', description: '查看 AIbak 平台公开运行状态', path: '/platform-status', group: '核心功能', keywords: ['状态', '可用性', 'SLA'], aliases: ['status'], authRequired: false, icon: 'dashboard' },
  ...
  { id: 'code-lab', title: '代码实验室', description: '在隔离沙盒运行代码 + AI 解释分析，写码→执行→理解→验证一站式闭环', path: '/lab', group: '核心功能', keywords: ['运行代码', 'Python', 'JavaScript', 'Java', 'Go', '编程', '解释代码', '沙盒'], aliases: ['code-lab', 'code lab', 'sandbox', '代码沙盒', 'code', '代码实验室'], authRequired: false, icon: 'code' },
  ...
  { id: 'flow', title: 'NexMind Flow', description: '将 AI 成果自动归档到知识库', path: '/flow', group: '工具与分析', keywords: ['Obsidian', '同步', '知识沉淀', 'Vault'], aliases: ['flow', '知识同步'], authRequired: true, icon: 'workflow' },
  { id: 'transync', title: '实时翻译', description: 'AIbak × TranSync 多语言实时翻译工作台', path: '/transync', group: '工具与分析', keywords: ['翻译', '实时翻译', '多语言', 'TranSync', '中英互译'], aliases: ['translate', 'translator', '翻译器'], authRequired: false, icon: 'translate' },
  ...
  { id: 'developer', title: '开发者门户', description: '创建 API Key、查看接入文档与用量', path: '/developer', group: '平台与生态', keywords: ['API Key', '开发者', '开放接口'], aliases: ['developer', 'API门户'], authRequired: true, icon: 'api' },
  ...
  { id: 'my-dashboard', title: '我的工作台', description: '个人项目统计、评分历史与使用数据', path: '/my-dashboard', group: '管理与账户', icon: 'dashboard', keywords: ['仪表板', '统计', '报告', '项目'], aliases: [], authRequired: true },  { id: 'ops-dashboard', title: '运营看板', description: '查看平台运营指标', path: '/ops-dashboard', group: '管理与账户', keywords: ['运营', '统计', '指标'], aliases: ['dashboard'], authRequired: true, roles: ['admin'], icon: 'chart' }, { id: 'ops-monitor', title: '全域运维监控', description: '本地、云端、CNB 与故障切换控制台', path: '/ops-monitor', group: '管理与账户', keywords: ['监控', '故障切换', 'CNB', '运维'], aliases: ['monitor', 'operations'], authRequired: true, roles: ['admin'], icon: 'dashboard' },
  { id: 'admin-knowledge-products', title: '知识产品管理', description: '从 Vault 导入、发布和管理知识商品', path: '/admin/knowledge-products', group: '管理与账户', keywords: ['知识商品', '课程', '发布', 'Vault'], aliases: ['知识产品后台'], authRequired: true, roles: ['admin'], icon: 'book' },
  ...
  { id: 'referral', title: '推荐分销', description: '推荐码管理、佣金统计与提现', path: '/referral', group: '管理与账户', keywords: ['推荐', '分销', '佣金', '推广', '拉新'], aliases: ['referral', '推荐有奖'], authRequired: true, icon: 'share' },
  ...
  { id: 'shop', title: '知识商城', description: '浏览和购买精选知识产品', path: '/shop', group: '平台与生态', keywords: ['知识商城', '购买', '知识产品', '文档'], aliases: ['shop', '知识商店'], authRequired: false, icon: 'shop' },
...
export const NAVIGATION_GROUPS: NavigationGroup[] = [
  { key: 'core', label: '核心功能', defaultOpen: true, featureIds: ['home', 'platform-status', 'quickstart', 'ai-chat', 'knowledge', 'code-lab'] },
  { key: 'create', label: '创作与学习', featureIds: ['courses', 'learning-path', 'creative'] },
  { key: 'tools', label: '工具与分析', featureIds: ['tools', 'flow', 'transync', 'compare', 'calendar', 'workflows', 'project-grade'] },
  { key: 'platform', label: '平台与生态', featureIds: ['query-center', 'model-config', 'developer', 'marketplace', 'skills', 'plugins', 'customer-service', 'relay-admin', 'shop', 'jinwangtong'] },
  { key: 'manage', label: '管理与账户', featureIds: ['my-dashboard', 'team', 'diagnostics', 'ops-dashboard', 'admin-knowledge-products', 'admin-users', 'pricing', 'points-center', 'referral', 'profile'] },
];
