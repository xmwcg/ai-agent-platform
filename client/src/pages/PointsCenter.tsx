            ...
            children: (
              <Row gutter={[16, 16]}>
                {[
                  ...
                  {
                    name: '专业版', plan: 'pro', price: '¥9.9/月', competitorPrice: '竞品 ¥99/月', discountLabel: '1折', color: '#6366f1',
                    features: ['无限 AI 对话', '高级知识库', '模型对比', '日配额 500 积分', 'API 开放', '媒体生成'],
                    disabled: ['团队协作', '优先客服'],
                    highlighted: true,
                  },
                  {
                    name: '旗舰版', plan: 'max', price: '¥19.9/月', competitorPrice: '竞品 ¥145/月', discountLabel: '1折', color: '#f59e0b',
